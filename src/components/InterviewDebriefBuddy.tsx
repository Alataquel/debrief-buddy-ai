    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-primary text-white">
        <div className="max-w-6xl mx-auto px-6 py-16 space-y-8">
          ...
          {!debriefData && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 animate-fade-in">
              {features.map((feature, index) => (
                <Card key={index} className="border-0 bg-white/10 backdrop-blur-sm hover:bg-white/15 transition-all duration-300">
                  <CardContent className="p-6 text-center space-y-3">
                    <div className="h-12 w-12 bg-white/20 rounded-lg flex items-center justify-center mx-auto">
